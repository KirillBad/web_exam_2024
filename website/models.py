...
class Book(db.Model):
    ...
    styles : Mapped[list['Style']] = db.relationship(back_populates='books', uselist=True,  secondary='book_style')
...
class Style(db.Model):
    ...
    books : Mapped[list['Book']] = db.relationship(back_populates='styles', uselist=True, secondary='book_style', )

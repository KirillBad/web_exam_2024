    ...
    if 'file' in request.files:
        ...
        if file and allowed_file(file.filename):   
            ...
            try:
                ...
                styles = db.session.scalars(db.select(Style).where(Style.id.in_(style))).all()
        ...
        book.short_description = request.form.get('short_description')
...
def view_book(id):
    ...
    return render_template("view_book.html", user=current_user, book=book, styles=styles, reviews=reviews, user_reviewed=user_reviewed)
